    ...
    template {
      metadata {
        ...
        annotations = {
          ...
          "consul.hashicorp.com/connect-service-upstreams" = "backend:80"
        }              
      }
...
# Phase 1 > annotation 주석을 모두 비활성화 후 terraform apply
# Phase 2 > annotation 주석을 활성화 후 terraform apply
# Phase 3 > annotation 중 "consul.hashicorp.com/connect-service-upstreams" = "backend:80" 활성화
#
# UI 활성화 확인
